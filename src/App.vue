<template>
  <div class="page">
    ...
    <div class="sharing-wrapper">
      <span class="text-black-50 small">Share this: </span> <a target="_blank" :href="`https://twitter.com/intent/tweet?text=Flow%20Lines%20SVG%20generator&via=msurguy&url=https://msurguy.github.io/flow-lines${currentURLHash}`">
